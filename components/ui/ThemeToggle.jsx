...
export function ThemeToggle() {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className='border-[1px] bg-transparent text-black dark:text-white hover:bg-transparent border-slate-400 dark:border-white rounded-xl'>
